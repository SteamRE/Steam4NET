...
namespace Steam4NET
{
	...
	[InterfaceVersion("SteamNetworking002")]
	public interface ISteamNetworking002
	{
		[VTableSlot(0)]
		...
		[VTableSlot(10)]
		bool GetSocketInfo(UInt32 hSocket, ref CSteamID pSteamIDRemote, ref ESNetSocketState peSocketStatus, ref UInt32 punIPRemote, ref UInt16 punPortRemote);
		[VTableSlot(11)]
